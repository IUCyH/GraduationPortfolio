...
public static class CharacterDataTable
{
    ...
    {
        characterTable.Add(new PlayerInfo("신영", "망상가득 활기찬 모범반장", "성별 : 여","별자리 : 쌍둥이 자리","특이사항 : 주변이 온통 상상으로 가득참"));
        characterTable.Add(new PlayerInfo("지은", "망상가득 활기찬 모범반장", "성별 : 여","별자리 : 쌍둥이 자리","특이사항 : 주변이 온통 상상으로 가득참"));
        characterTable.Add(new PlayerInfo("재환", "망상가득 활기찬 모범반장", "성별 : 여","별자리 : 쌍둥이 자리","특이사항 : 주변이 온통 상상으로 가득참"));
    }
